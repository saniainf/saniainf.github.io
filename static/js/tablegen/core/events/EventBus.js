// EventBus.js
// Простая шина событий для обмена сообщениями между модулями (минималистичный emitter).
// Map хранит соответствие имени события и множества (Set) обработчиков.
...
export class EventBus {
  ...
  /**
   * Приостановить доставку событий (поддерживает вложенность). Пока активна — события буферизуются.
   */
  pause() {
    this._pauseDepth++;
