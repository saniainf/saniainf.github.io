...
// Задача: извлечь структуру, учесть rowspan/colspan и вернуть нормализованные ячейки.
// Для джуниора: нам нужно развернуть таблицу так, чтобы каждая ведущая ячейка имела координаты r,c и размеры.
